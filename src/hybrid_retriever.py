...
if __name__ == "__main__":
    ...
    sample_docs = [
        Document(page_content="台積電 2024 年第一季營收達到 5926 億元新台幣。",
                 metadata={"source": "TSM_Q1"}),
        Document(page_content="蘋果 2024 年重點佈局 AI 伺服器與邊緣運算。",
                 metadata={"source": "AAPL_2024"}),
        Document(page_content="台積電先進製程 3nm 產能滿載，帶動毛利率上升。",
                 metadata={"source": "TSM_Q1"})
    ]
    ...
    for i, doc in enumerate(results):
        print(
            f"Rank {i+1} [Source: {doc.metadata['source']}] : {doc.page_content}")
